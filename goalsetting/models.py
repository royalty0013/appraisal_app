...
class Goal_Form(models.Model):
	...
	class meta:
		verbose_name = 'Goal form'
		verbose_name_plural = 'Goal forms'


	def __str__(self):
		return self.first_name

class period_info(models.Model):
...
class goal_info(models.Model):
	...
	specific_task =models.TextField(max_length=500)
	KPI = models.TextField(max_length=500)
	Strategic_focus = models.CharField(max_length=90, choices=STRATEGIC_FOCUS)
	Balanced_scorecard = models.CharField(max_length=90, null=True)
